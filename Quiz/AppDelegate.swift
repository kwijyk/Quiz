...
//
//        if !FileManager.defaultManager().fileExistsAtPath(url.path!) {
//            let sourceSqliteURLs = [Bundle.main.URLForResource("CoreDataDemo", withExtension: "sqlite")!, Bundle.main.URLForResource("CoreDataDemo", withExtension: "sqlite-wal")!, Bundle.mainBundle().URLForResource("CoreDataDemo", withExtension: "sqlite-shm")!]
//
